...
> **Public redaction note.** Local absolute paths in the historical console excerpts are replaced by `<UM_HARNESS_WORK_DIR>`. Exit codes, outputs, failure counts and verdicts are unchanged.
...
ArchRoot : <UM_HARNESS_WORK_DIR>
Data     : <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv
...
schema_text                               0 schema <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv
schema_json_suffix_format                 0 schema <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --for…
schema_json_prefix_format                 0 --format json schema <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sa…
schema_json_equals_format                 0 --format=json schema <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sa…
variables_text                            0 variables <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv
variables_json                            0 variables <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --…
correlate_text                            0 correlate <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --…
correlate_json                            0 correlate <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --…
explain_text                              0 explain <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --ta…
explain_json                              0 explain <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --ta…
simulate_text                             0 simulate <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --t…
simulate_json                             0 simulate <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --t…
report_text                               0 report <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --tar…
report_json                               0 report <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --tar…
report_deterministic_first                0 report <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --tar…
report_deterministic_second_same_command  0 report <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --tar…
...
unknown_option                            2 schema <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --bog…
invalid_format                            2 schema <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --for…
duplicate_format                          2 schema <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --for…
correlate_missing_target                  2 correlate <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv
simulate_missing_var                      2 simulate <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --t…
simulate_missing_delta                    2 simulate <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --t…
simulate_invalid_delta                    2 simulate <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --t…
report_missing_output                     2 report <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --tar…
schema_missing_csv                        0 schema <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\missing.csv
correlate_unknown_target                  2 correlate <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --…
correlate_non_numeric_target              2 correlate <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --…
simulate_unknown_driver                   2 simulate <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --t…


Logs : <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\logs

=== ÉCHECS DÉTECTÉS ===
[schema_text] STDOUT ne contient pas le jeton attendu : score
  Args   : python -m app.cli schema <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv
  RC     : 0
  STDOUT : <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\logs\009_schema_text.stdout.txt
  STDERR : <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\logs\009_schema_text.stderr.txt
...
[schema_json_suffix_format] Le JSON ne contient pas le jeton attendu : exposure
  Args   : python -m app.cli schema <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --format json
  RC     : 0
  STDOUT : <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\logs\010_schema_json_suffix_format.stdout.txt
  STDERR : <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\logs\010_schema_json_suffix_format.stderr.txt
...
[schema_missing_csv] Code retour attendu 2, obtenu 0.
  Args   : python -m app.cli schema <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\missing.csv
  RC     : 0
  STDOUT : <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\logs\041_schema_missing_csv.stdout.txt
  STDERR : <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\logs\041_schema_missing_csv.stderr.txt
...
schema commands: correlate, explain, report, schema, simulate, variables
  ...
  STDERR preview:
<empty>
Exception: <UM_HARNESS_WORK_DIR>\test_um_harness_manual_causalab.ps1:751
Line |
...
simulate_invalid_delta                    2 simulate <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --t…
report_missing_output                     2 report <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --tar…
schema_missing_csv                        2 schema <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\missing.csv
correlate_unknown_target                  2 correlate <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --…
correlate_non_numeric_target              2 correlate <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --…
simulate_unknown_driver                   2 simulate <UM_HARNESS_WORK_DIR>\.tmp_um_harness_manual_causalab\input\causalab_sample.csv --t…
