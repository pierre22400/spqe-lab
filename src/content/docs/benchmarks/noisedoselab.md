...
**Initial qualification.** Kiro reached 251 of 254 executable controls. ARCHCode passed 215 of 250. The ARCHCode calculation logic was judged correct on the checked scientific behaviours, but cross-module contract closure and integration consistency required further work.

**Boundary of this result.** Unlike the first two benchmarks, no comparative local-repair cycle was completed for ARCHCode in this series. The score must therefore remain an initial-generation result.

## Takeaway

NoiseDoseLab is the most demanding benchmark in the series because it combines scientific calculation, CLI behaviour, validation, reporting and documentation. It reinforces the central finding: the remaining ARCHCode weakness is identifiable as first-shot integration consistency, not simply missing business logic.
